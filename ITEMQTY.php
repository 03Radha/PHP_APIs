...
// Group by both Cust_Name and Item_Name to calculate total quantity and amount per item per customer
$query .= " GROUP BY m.Cust_Name, d.Item_Name ORDER BY m.Cust_Name, d.Item_Name ASC";
